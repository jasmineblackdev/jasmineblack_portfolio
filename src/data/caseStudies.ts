...
export const caseStudyDetails: Record<string, CaseStudyDetail> = {
  formiq: {
    title: "FormIQ",
    tagline: "AI form feedback designed to feel clear and supportive, not technical or intimidating",
    role: "UI / Product Designer",
    ...
    slug: "formiq",
    overview:
      "FormIQ is a mobile fitness app that uses AI-assisted analysis to help everyday gym-goers improve their exercise form. Users record a set, receive an AI-generated score and plain-language correction cues within seconds, and track technique trends across sessions. The design challenge was not making the AI smarter — it was making the feedback feel clear, supportive, and immediately actionable for users who don't have a coach. I led end-to-end product design: user flows, component system, interaction design, and developer handoff specifications.",
    problem:
      "Most fitness apps assume users already understand proper lifting mechanics. In practice, most users are unsure whether their form is correct, don't know what to fix when something feels off, and feel overwhelmed by technical feedback. AI-based form analysis exists — but it's typically difficult to interpret, visually cluttered, and framed in a way that discourages anyone who isn't already advanced. Poor form is the leading cause of gym injuries and stalled progress, and the only accessible alternatives — a personal trainer or a knowledgeable training partner — aren't always available. The feedback gap is invisible until something goes wrong.",
    users:
      "Intermediate gym-goers (18–35) who train consistently but don't have regular access to coaching. They have enough experience to care about technique but not enough certainty to self-correct confidently. They open FormIQ between sets — one hand, 30 seconds, zero patience for multi-step flows. They need feedback that feels clear and supportive, not clinical or overwhelming.",
    goals: [
      "Make AI form feedback immediately understandable at a glance — no technical knowledge required to act on it",
      "Design a sub-30-second core loop (Record → Analyze → Review) completable one-handed mid-workout",
      "Reduce intimidation around form correction — the product should guide users toward improvement, not make them feel judged",
      "Build a component system that scales to 20+ exercises without visual inconsistency",
    ],
    constraints: [
      ...
      "4-week scope — core loop prioritized before any secondary features; social and community features deferred to V2",
    ],
    myRole:
      "Led end-to-end product design — user flows, component architecture, interaction design, visual system, and developer handoff specifications. Sole designer on the project from concept through production-ready screens.",
    solution:
      "A camera-first mobile app with a one-tap record flow, AI form scoring, and plain-language correction cues delivered before the next set starts. Feedback is designed to feel supportive, not judgmental — the ring score communicates pass/fail visually before the user reads a single word, and color-coded cards separate strengths from corrections so users know exactly what to do next. A history view tracks technique trends across sessions so users can see whether they're improving, not just whether they worked out.",
    designApproach: [
      "Skipped wireframes. Started with rapid high-fidelity layout exploration — testing hierarchy, feedback placement, and content density at real screen fidelity from the first iteration. Low-fidelity would have hidden the layout and legibility problems that matter most in a gym context.",
      "Started with the Analysis result screen, not the record flow — the feedback card is the moment the product's value is delivered or lost. If the output isn't readable in under 5 seconds, nothing before it matters.",
      "Explored three scoring formats: text report, number only, and ring score with color-coded breakdown. The ring won — it communicates pass/fail before the user reads a single word, which matters when attention is split between sets.",
      "Mapped every interactive element to a one-handed thumb zone before finalizing any layout. Record, stop, and review all land in the bottom third — the only reliably reachable zone during an active session.",
      "Designed the Form History empty state as an active entry point, not a dead end — it explains the save flow and surfaces a direct CTA. A zero-content screen that teaches nothing is a churn trigger.",
    ],
    designRationale: [
      "Dark-first color system (#0D0D0D) keeps the UI low-glare and legible under bright gym overhead lighting — a context-specific decision that also reads as a premium, modern aesthetic.",
      "The Record action lives as a raised circular button in the center tab bar position, breaking the flat icon pattern to signal permanent one-tap access to the core function from any screen.",
      ...
      "The AI Analysis screen leads with a circular ring score (52/100) before any text — users get the pass/fail verdict instantly; detailed coaching is available when they're ready to dig in.",
      "Color-coded feedback cards (green = strength, amber = correction) let users triage positive vs. corrective feedback at a glance without reading every line mid-workout.",
      "The freemium usage counter ('4 free analyses remaining') surfaces in the header subtitle — limits are communicated transparently without interrupting the result experience with a paywall modal.",
      "The Form History empty state is instructional, not a dead end — it explains exactly how to trigger the save flow and provides a direct CTA, converting a zero-content screen into an active entry point.",
    ],
    decisions: [
      "Ring score over text feedback — the single evaluation criterion: can a user understand whether they're on track without reading a word? The ring was the only format that passed in a split-attention gym context.",
      "Feedback framed as strengths and corrections, not a pass/fail grade — the language and color system were designed to guide improvement, not create anxiety around imperfect form.",
      "Mandatory exercise selection before analysis — removing this step created ambiguous, lower-trust AI output. Short-term friction accepted for accurate, reliable results.",
      "Social, community, and sharing features deferred to V2 entirely — shipping a focused, well-executed V1 is worth more than shipping every feature at half quality.",
    ],
    outcome:
      "FormIQ is a complete, developer-ready product foundation — 20+ screens, a documented component system, and an active GitHub repository. The core loop (Record → Analyze → Review) is fully realized end-to-end with no placeholder screens. The design demonstrates the ability to make a technically complex AI output feel simple, supportive, and immediately actionable for a non-expert audience.",
    nextSteps: [
      "Live pose-detection overlays using TensorFlow Pose or Apple's Vision framework for real-time in-rep feedback",
      "React Native implementation targeting cross-platform App Store distribution",
      "AI coaching mode that adapts correction cues based on historical form progression data",
    ],
    links: [
      {
        label: "View Live App",
    ...
    screenshotRationale: [
      ...
      "The AI Analysis screen leads with a circular ring score (52/100) before any text — users get the pass/fail verdict instantly; detailed coaching is available when they're ready to dig in.",
      "Color-coded feedback cards (green = strength, amber = correction) let users triage positive vs. corrective feedback at a glance without reading every line mid-workout.",
      "The freemium usage counter ('4 free analyses remaining') surfaces in the header subtitle — limits communicated transparently without interrupting the result experience with a paywall modal.",
      "The Form History empty state is instructional, not a dead end — it explains exactly how to trigger the save flow and provides a direct CTA, converting a zero-content screen into an active entry point.",
    ],
  },
  ...
  macrocore: {
    title: "MacroCore",
    tagline: "iOS nutrition tracker designed for daily habit, not one-time setup",
    role: "UI / Product Designer",
    platform: "Mobile (iOS)",
    timeline: "3 weeks",
    ...
    slug: "macrocore",
    overview:
      "MacroCore is an iOS macro-tracking app designed to solve a retention problem, not a feature problem. Most nutrition apps fail because they're data-dense, slow to use, and require daily re-learning — so users log for two weeks and stop. MacroCore strips the interface down to what a fitness-focused user actually needs: their macro status at a glance, a fast logging flow, and a goal system they set once and trust. I owned end-to-end product design — information architecture, component system, visual design, and high-fidelity prototyping in both light and dark mode.",
    problem:
      "Nutrition tracking apps have a retention problem, not a feature problem. MyFitnessPal, Cronometer, and Lose It surface dense dashboards, require multiple taps to log a single meal, and bury macro status below the fold. The result: users log for two weeks, lose the habit, and stop. The design challenge wasn't building a better food database — it was building an interface fast enough, simple enough, and consistent enough that stopping feels harder than continuing.",
    users:
      "Fitness-focused adults (22–38) who track macros as part of a consistent training routine — from people building a logging habit to athletes in prep who need daily precision. What they share: they want their macro status confirmed in under 10 seconds. They won't re-learn an app that changes between sessions. And they'll abandon any tracker that makes logging feel like work.",
    goals: [
      "Daily macro status readable above the fold in under 10 seconds — no scrolling, no arithmetic required",
      "Onboarding delivers a complete personalized macro target before the user's first logged meal",
      "Logging flow completable in 3 taps or fewer for a repeat food entry — friction is the reason people stop",
      "Component system that accommodates future AI meal planning features without structural changes",
    ],
    constraints: [
      "Mobile-only — every spacing, touch target, and hierarchy decision optimized for a single-screen context",
      "Nutrition data must stay accurate and readable — clarity can't be achieved by hiding information",
      "Light and dark mode at full fidelity — not a theme-toggle afterthought, built on the same token system",
      "3-week scope — social sharing, recipe import, and AI meal planning deferred to V2",
    ],
    myRole:
      "End-to-end product design — information architecture, component system, visual design, and high-fidelity prototyping in Figma. Light and dark mode designed simultaneously at full fidelity, not retrofitted.",
    solution:
      "A stripped-down daily tracking interface built on three design decisions: a glanceable calorie ring as the dashboard hero, a minimal onboarding flow with contextual coaching copy, and a consistent component system that makes the app feel automatic after the first week. The product is designed for habit, not novelty.",
    designApproach: [
      "Skipped wireframes entirely. Jumped directly to high-fidelity layout exploration — testing real content density against real typography and spacing from day one. Low-fidelity would have hidden the hierarchy problems that matter most in a data-heavy interface.",
      "Ran five dashboard layout iterations with a single test criterion: can a user confirm they're on track without reading a number? Tested table layouts, horizontal progress bars, and ring charts. The ring was the only format that passed.",
      "Iterated the goal-setting onboarding until every input felt obviously sequenced and no step required explanation. Assumed any screen where a user hesitates is a drop-off point.",
      "Designed light and dark mode in parallel at the same fidelity — both built on the same token system. Neither mode was added as an afterthought or layered in at the end.",
    ],
    designRationale: [
      "'One number, not a spreadsheet' — the splash screen tagline names the failure mode of every competing tracker before the user taps anything. The value proposition is established before onboarding begins.",
      "'Takes about 60 seconds' micro-copy directly below the onboarding CTA sets a time expectation that reduces drop-off anxiety — one line of copy doing real conversion work without adding a screen.",
      "A progress bar across the top of the goal-setting screen makes the end of onboarding visible at every step — showing users exactly how close they are to their macro plan reduces mid-flow abandonment.",
      "Contextual coaching ('0.5–1 lb/week is ideal for lean gains') appears inline at the decision point, not in a help section — coaching is delivered at the moment it's needed, zero extra taps.",
      "The calorie ring on the dashboard communicates daily progress through arc completion before any number is read — primary status check is above the fold and readable in under a second.",
      "Protein, Carbs, and Fat each carry a distinct color on the Goals screen — three macro values distinguishable at a glance without parsing labels or running comparisons.",
    ],
    decisions: [
      "High-fidelity exploration over wireframes — testing at real content density from day one surfaced hierarchy and spacing problems that low-fidelity would have hidden until much later in the process.",
      "Ring chart as the primary macro visualization — the single evaluation criterion was whether a user could confirm their status without reading a number. The ring was the only format that consistently passed.",
      "Minimum-tap logging flow — every additional step was pressure-tested against whether it served accuracy or user understanding. Friction is the documented primary reason people abandon trackers.",
      "Scalable component system designed from the start — the layout accommodates AI-generated meal plans and expanded trend data without requiring structural changes at V2.",
    ],
    outcome:
      "MacroCore is a production-ready product design — four complete high-fidelity screens, light and dark mode at full fidelity, and a documented component system. The core daily loop (Open → Check macros → Log meal) is fully realized with no placeholder screens. The design is ready for a React Native implementation targeting App Store release.",
    nextSteps: [
      "AI-generated meal suggestions based on remaining daily macros and logged food history",
      "Weekly macro adherence trend view — progress visualized over time without increasing dashboard complexity",
      "React Native implementation for App Store submission",
    ],
    screenshots: [
